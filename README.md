...
```json
{
  ...
  "developer_data": {
    ...
    "last_4_weeks_commit_activity_series": [
      3, 8, 3, 7, 11, 4, 1, 5, 4, 5, 2, 9, 6, 3, 0, 8, 3, 1, 3, 1, 0, 0, 0, 0,
      0, 0, 0, 0
    ]
  },
...
| ---------------------------------------------------------------------- | :------: | :------------: | :-----------: | :---------: |
| Setting up HTML boiler plate                                           |    H     |      1hrs      |     1hrs      |    1hrs     |
| Adding API                                                             |    H     |      3hrs      |     1hrs      |    1hrs     |
| Adding Form for search bar                                             |    H     |      3hrs      |     2hrs      |    2hrs     |
| Fetch data for individual crypto search                                |    H     |      3hrs      |     1hrs      |    1hrs     |
| Create click event for search bar                                      |    H     |      3hrs      |     2hrs      |    2hrs     |
| Fetch data list for reference currency                                 |    H     |      3hrs      |     1hrs      |    1hrs     |
| Create option list from reference currency list                        |    H     |      3hrs      |     2hrs      |    2hrs     |
| Link selected reference currency to indivudal crypto search function   |    H     |      3hrs      |     2hrs      |    2hrs     |
| Append results to DOM                                                  |    H     |      3hrs      |     2hrs      |    2hrs     |
| Create remove function for past results                                |    H     |      3hrs      |     1hrs      |    1hrs     |
| Add icons                                                              |    H     |      3hrs      |     1hrs      |    1hrs     |
| Format text for MVP                                                    |    H     |      2hrs      |     1hrs      |    1hrs     |
| Flexbox & CSS for MVP                                                  |    H     |      3hrs      |     2hrs      |    2hrs     |
| Add media queries for MVP                                              |    H     |      3hrs      |     3hrs      |    3hrs     |
| Adding 2nd API for multiple Crypto                                     |    H     |      3hrs      |     2hrs      |    2hrs     |
| Fetch data for multiple cryptos                                        |    H     |      3hrs      |     2hrs      |    2hrs     |
| Append multiple results to DOM                                         |    H     |      3hrs      |     2hrs      |    2hrs     |
| Format text for API 2                                                  |    H     |      3hrs      |     1hrs      |    1hrs     |
| Flexbox & CSS for API 2                                                |    H     |      3hrs      |     2hrs      |    2hrs     |
| Add media queries for multiple crypto                                  |    H     |      3hrs      |     2hrs      |    2hrs     |
| Added: Currency dropdown for coin overview section                     |    H     |      1hrs      |    0.5hrs     |   0.5hrs    |
| Added: linked currency dropdown to multi coin array                    |    H     |      1hrs      |    0.5hrs     |   0.5hrs    |
| Added: add table section in HTML to show price change change over time |    H     |      2hrs      |     2hrs      |    2hrs     |
| Added: get results for the different price changes over time           |    H     |      2hrs      |     1hrs      |    1hrs     |
| Added: show results of crypto price change over time into DOM table    |    H     |      2hrs      |     2hrs      |    2hrs     |
| Added: Hide & show function for table                                  |    H     |      2hrs      |     2hrs      |    2hrs     |
| Added: Apply Flexbox to price change over time table                   |    H     |      2hrs      |     1hrs      |    1hrs     |
| Added: Apply Mediaquery to price change over time table                |    H     |      2hrs      |     2hrs      |    2hrs     |
| Added: create function that changes color of number if neg or pos      |    H     |      2hrs      |     2hrs      |    2hrs     |
| Added: function if you click coin from array, returns detailed info    |    H     |      2hrs      |     2hrs      |    2hrs     |
| Total                                                                  |    H     |     75hrs      |     48hrs     |    48hrs    |
...
```
// Get data from API and Append results to DOM for individual crypto search
